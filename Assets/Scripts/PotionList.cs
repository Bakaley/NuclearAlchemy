...
public class PotionList : MonoBehaviour
{
    ...
    List<GameObject> lensingList
    {
        ...
        {
            List<GameObject> list = new List<GameObject>();
            if (potionLevelDictionary[progressing_standard_plus1] == 0) list.Add(progressing_standard_plus1);
            else list.Add(standard_plus1);
            if (potionLevelDictionary[progressing_standard_plus2] == 0) list.Add(progressing_standard_plus2);
            else list.Add(standard_plus2);
            if (potionLevelDictionary[progressing_standard_plus3] == 0) list.Add(progressing_standard_plus3);
            else list.Add(standard_plus3);
    ...
    private void Awake()
    {
        ...
        potionLevelDictionary.Add(progressing_colorant2, 1);
        ...
        potionLevelDictionary.Add(colorant_aether2, 1);
        ...
        potionLevelDictionary.Add(aether_voids2, 1);
        ...
        potionLevelDictionary.Add(aether_supernova2, 1);
